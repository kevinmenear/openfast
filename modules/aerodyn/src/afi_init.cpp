...
// CheckValues is a standalone verified C++ unit
// (checkvaluesareuniquemonotonicincreasing.cpp) — called, not inlined
// (VIT no-inline discipline). C++ linkage: it is only called from C++.
