...
!Generated at : 2026-04-24 17:21:52 
!KGEN version : 0.8.1 
...
! Redo this routing to get rid of some of the phases.  For instance, AFI_Init should be calle directly.
    ...
    PUBLIC afi_computeairfoilcoefs2d 
...
!----------------------------------------------------------------------------------------------------------------------------------  
SUBROUTINE afi_computeairfoilcoefs2d(kgen_unit, kgen_measure, kgen_isverified, kgen_filepath, secondarydepval, p) 
...
!..................................................................................................................................
    ...
    INTEGER :: kgenref_lowertable 
    INTEGER :: kgenref_uppertable 
    REAL(KIND=reki), dimension(2) :: kgenref_xvals 
      
    !parent block preprocessing 
    kgen_mpirank = 0 
      
    !local input variables 
    READ (UNIT = kgen_unit) lowertable 
    READ (UNIT = kgen_unit) uppertable 
    READ (UNIT = kgen_unit) kgen_istrue 
    IF (kgen_istrue) THEN 
        READ (UNIT = kgen_unit) kgen_array_sum 
        READ (UNIT = kgen_unit) xvals 
        CALL kgen_array_sumcheck("xvals", kgen_array_sum, DBLE(SUM(xvals, mask=(xvals .eq. xvals))), .TRUE.) 
    END IF   
      
    !extern output variables 
      
    !local output variables 
    READ (UNIT = kgen_unit) kgenref_lowertable 
    READ (UNIT = kgen_unit) kgenref_uppertable 
    READ (UNIT = kgen_unit) kgen_istrue 
    IF (kgen_istrue) THEN 
        READ (UNIT = kgen_unit) kgen_array_sum 
        READ (UNIT = kgen_unit) kgenref_xvals 
        CALL kgen_array_sumcheck("kgenref_xvals", kgen_array_sum, DBLE(SUM(kgenref_xvals, mask=(kgenref_xvals .eq. &
        &kgenref_xvals))), .TRUE.) 
    END IF   
      
   

   !$kgen begin_callsite FindBoundingTables
   ...
   IF (kgen_mainstage) THEN 
       ...
       CALL kv_afi_computeairfoilcoefs2d_integer__("uppertable", check_status, uppertable, kgenref_uppertable) 
       CALL kv_afi_computeairfoilcoefs2d_integer__("lowertable", check_status, lowertable, kgenref_lowertable) 
       CALL kv_kgen_afi_computeairfoilcoefs2d_subp0("xvals", check_status, xvals, kgenref_xvals) 
   ...
   call FindBoundingTables(p, secondaryDepVal, lowerTable, upperTable, xVals)
       ...
       IF (check_status%rank==0) THEN 
           WRITE (*, *) "FindBoundingTables : Time per call (usec): ", kgen_measure 
       END IF   
   END IF   
   IF (kgen_warmupstage) THEN 
   END IF   
...
!fixme ERROR HANDLING!   
   ...
   !verify state subroutine for kv_afi_computeairfoilcoefs2d_integer__ 
   RECURSIVE SUBROUTINE kv_afi_computeairfoilcoefs2d_integer__(varname, check_status, var, kgenref_var) 
   ...
   END SUBROUTINE kv_afi_computeairfoilcoefs2d_integer__ 
     
   !verify state subroutine for kv_kgen_afi_computeairfoilcoefs2d_subp0 
   RECURSIVE SUBROUTINE kv_kgen_afi_computeairfoilcoefs2d_subp0(varname, check_status, var, kgenref_var) 
       CHARACTER(LEN=*), INTENT(IN) :: varname 
       TYPE(check_t), INTENT(INOUT) :: check_status 
   ...
   END SUBROUTINE kv_kgen_afi_computeairfoilcoefs2d_subp0 
