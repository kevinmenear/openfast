...
! =======================
  ...
  RECURSIVE SUBROUTINE kr_airfoilinfo_types_afi_parametertype(var, kgen_unit, printname, printvar) 
      ...
      IF (PRESENT( printvar ) .AND. printvar) THEN 
          CALL kr_kgen_afi_parametertype_subp3(var%table, kgen_unit, printname // "%table", .TRUE.) 
      ELSE 
          CALL kr_kgen_afi_parametertype_subp3(var%table, kgen_unit, printname // "%table", .FALSE.) 
      END IF   
  ...
  !write state subroutine for kr_kgen_afi_parametertype_subp3 
  SUBROUTINE kr_kgen_afi_parametertype_subp3(var, kgen_unit, printname, printvar) 
  ...
  END SUBROUTINE kr_kgen_afi_parametertype_subp3 
