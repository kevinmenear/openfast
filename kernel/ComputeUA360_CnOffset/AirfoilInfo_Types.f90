...
!read state subroutine for kw_airfoilinfo_types_afi_ua_bl_type 


!read state subroutine for kw_airfoilinfo_types_afi_table_type 
  


!write state subroutine for kw_afi_table_type_real__reki_dim1 
  


!write state subroutine for kw_afi_table_type_real__reki_dim2 
  


!write state subroutine for kw_afi_table_type_real__reki_dim3 
